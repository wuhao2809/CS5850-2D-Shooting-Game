 ...
 * Tracks projectile behavior including speed, range limits, and distance
 * traveled.
 *
...
public:
   ...
   * @param maxRange Maximum distance the projectile can travel before being
   * destroyed (default: 800.0)
   * @param traveledDistance Distance already traveled (default: 0.0)
   */
  Projectile(const game::ecs::Entity &entity, float speed = 800.0f,
             float maxRange = 800.0f, float traveledDistance = 0.0f);
  ...
  float maxRange; ///< Maximum distance the projectile can travel before being
                  ///< destroyed
