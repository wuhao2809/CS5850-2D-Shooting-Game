...
/**
 * System that spawns targets at regular intervals with different types and
 * behaviors. Manages target variety and positioning in the shooting gallery.
 *
 * Based on:
 * Lesson-40-WorldState/Python/src/game/ecs/systems/target_spawn_system.py
...
private:
  ...
  /**
   * Spawn a new duck at the left or right edge that will fly horizontally
   * across the screen.
   */
  void spawnTarget();
   ...
   */
  void createDuckFromTemplate(const Entity &entity, float x, float y,
